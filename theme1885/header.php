...
<head>
	<title><?php if ( is_category() ) {
		echo __('Category Archive for &quot;', 'theme1885'); single_cat_title(); echo __('&quot; | ', 'theme1885'); bloginfo( 'name' );
	} elseif ( is_tag() ) {
		echo __('Tag Archive for &quot;', 'theme1885'); single_tag_title(); echo __('&quot; | ', 'theme1885'); bloginfo( 'name' );
	} elseif ( is_archive() ) {
		wp_title(''); echo __(' Archive | ', 'theme1885'); bloginfo( 'name' );
	} elseif ( is_search() ) {
		echo __('Search for &quot;', 'theme1885').wp_specialchars($s).__('&quot; | ', 'theme1885'); bloginfo( 'name' );
	} elseif ( is_home() || is_front_page()) {
		bloginfo( 'name' ); echo ' | '; bloginfo( 'description' );
	}  elseif ( is_404() ) {
		echo __('Error 404 Not Found | ', 'theme1885'); bloginfo( 'name' );
	} elseif ( is_single() ) {
		wp_title('');
	} else {
...
<div id="main"><!-- this encompasses the entire Web site -->
	...
	<div id="facebook">
		<a href="<?php echo of_get_option('facebook_url'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/facebook.png" /></a>
	</div>
      </div>
		</div><!--.container_12-->
	</header>
