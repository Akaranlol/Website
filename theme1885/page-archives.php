	...
	<div id="content" class="grid_8 <?php echo of_get_option('blog_sidebar_pos') ?>">
			...
			<h1><?php the_title(); ?></h1>
                    ...
                    <div id="page-content">
                        ...
                        <?php wp_link_pages(array('before' => '<p><strong>'.__('Pages:', 'theme1885').'</strong> ', 'after' => '</p>', 'next_or_number' => 'number')); ?>
                        
                        <div class="archive-lists">
                            
                            <h4><?php _e('Last 30 Posts', 'theme1885') ?></h4>
                            ...
                            <h4><?php _e('Archives by Month:', 'theme1885') ?></h4>
                            
                            <ul>
                                <?php wp_get_archives('type=monthly'); ?>
                            </ul>
                
                            <h4><?php _e('Archives by Subject:', 'theme1885') ?></h4>
