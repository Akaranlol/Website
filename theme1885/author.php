...
<div class="extra-box clearfix <?php echo of_get_option('blog_sidebar_pos') ?>">
  ...
  <div class="author-info clearfix">
	...
	<h1><?php _e('About:', 'theme1885'); ?> <?php echo $curauth->display_name; ?></h1>
    </div>
    <div class="inner">
	<p class="avatar">
  ...
  <div id="recent-author-posts">
    <div class="header-title">
	<h3><?php _e('Recent&nbsp;Posts&nbsp;by', 'theme1885'); ?> <span><?php echo $curauth->display_name; ?></span></h3>
    </div>
		...
		if (have_posts()) : while (have_posts()) : the_post(); 
		 ...
		 <div class="no-results">
			<?php echo '<p><strong>' . __('No post yet.', 'theme1885') . '</strong></p>'; ?>
		</div><!--no-results-->
  ...
  <div id="recent-author-comments">
    <div class="header-title">
	<h3><?php _e('Recent&nbsp;Comments&nbsp;by', 'theme1885'); ?> <?php echo $curauth->display_name; ?></h3>
    </div>
      <?php
      ...
      <ul>
        ...
        endforeach; else: ?>
                  <p>
                    <?php _e('No comments by', 'theme1885'); ?> <?php echo $curauth->display_name; ?> <?php _e('yet.', 'theme1885'); ?>
                  </p>
        <?php endif; ?>
            </ul>
