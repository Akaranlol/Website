...
function button_shortcode($atts, $content = null) {
    ...
    $output =  '<div class="wrapper"><a href="'.$link.'" title="'.$text.'" class="button '.$size.'" target="'.$target.'">';
		$output .= $text;
		$output .= '</a></div><!-- .button (end) -->';
...
function link_shortcode($atts, $content = null) {
    ...
    $output =  '<a href="'.$link.'" class="button-arrow" target="'.$target.'"></a><!-- .link (end) -->';
