...
$meta_box_quote = array(
	...
	'title' =>  __('Quote Settings', 'theme1885'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The Quote','theme1885'),
				"desc" => __('Put your quote in this field.','theme1885'),
				"id" => $prefix."quote",
				"type" => "textarea"
			),
	),
...
$meta_box_link = array(
	'id' => 'tz-meta-box-link',
	'title' =>  __('Link Settings', 'theme1885'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The URL','theme1885'),
				"desc" => __('Insert the URL you wish to link to.','theme1885'),
				"id" => $prefix."link_url",
				"type" => "text"
			),
	),
...
$meta_box_image = array(
	...
	'title' =>  __('Image Settings', 'theme1885'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Enable Lightbox','theme1885'),
				"desc" => __('Check this to enable the lightbox.','theme1885'),
...
$meta_box_audio = array(
	...
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('MP3 File URL','theme1885'),
...
$meta_box_video = array(
	...
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Embeded Code','theme1885'),
				"desc" => __('You can include embeded code here.','theme1885'),
