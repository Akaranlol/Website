...
$meta_box_portfolio = array(
	...
	'title' =>  __('Portfolio Options', 'theme1885'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
			'name' =>  __('Format', 'theme1885'),
			'desc' => __('Choose post format that most fit your needs. ', 'theme1885'),
    	...
    	array(
    	   'name' => __('Date', 'theme1885'),
    	   'desc' => __('Input project end date. ', 'theme1885'),
    	   'id' => $prefix . 'portfolio_date',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Client', 'theme1885'),
    	   'desc' => __('Input project owner name. ', 'theme1885'),
    	   'id' => $prefix . 'portfolio_client',
    	   'type' => 'text',
    	   'std' => ''
    	),
			array(
    	   'name' => __('Info', 'theme1885'),
    	   'desc' => __('Additional info for this portfolio item.', 'theme1885'),
    	   'id' => $prefix . 'portfolio_info',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('URL', 'theme1885'),
    	   'desc' => __('Input the project URL (external link)', 'theme1885'),
...
$meta_box_portfolio_image = array(
	...
	'title' => __('Image Uploader', 'theme1885'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
...
$meta_box_portfolio_video = array(
	...
	'title' => __('Video Settings', 'theme1885'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Embedded Code', 'theme1885'),
			'desc' => __('Use this field to embed video from various websites (YouTube, Vimeo etc).', 'theme1885'),
...
$meta_box_portfolio_audio = array(
	...
	'title' =>  __('Audio Settings', 'theme1885'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( 
		    "name" => __('MP3 File URL','theme1885'),
				"desc" => __('The URL to the .mp3 audio file','theme1885'),
				"id" => $prefix."audio_mp3",
				"type" => "text",
				'std' => ''
		)
...
function tz_show_box_portfolio() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please choose desired Portfolio Format and fill additional fields. ', 'theme1885').'</p>';
...
function tz_show_box_portfolio_image() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please upload an image using the button below. Your images should be not thess than 620px width. Selecting post type "Slideshow" or "Grid Gallery" you will make the Featured Image to appear among others. ', 'theme1885').'</p>';
	// Use nonce for verification
	echo '<input type="hidden" name="tz_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
