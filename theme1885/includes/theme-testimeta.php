...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'theme1885'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'theme1885'),
    	   'desc' => __('Input author\'s name. ', 'theme1885'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input author\'s URL.', 'theme1885'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	   ...
    	   'desc' => __('Input author\'s additional info.', 'theme1885'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'theme1885').'</p>';
