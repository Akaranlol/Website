...
function theme1885_random($length){
					...
					<div class="grid_gallery clearfix">
						...
						?>
								...
								<?php foreach ($attachments as $attachment) : ?>
										...
										$image = aq_resize($url, 195, 120, true);
										?>
...
if ( !function_exists( 'tz_gallery' ) ) {
    function tz_gallery($postid, $imagesize) { ?>
        <?php $random = theme1885_random(10); ?>
				<script type="text/javascript">
					...
					<div class="g_pagination">
						...
						<div class="g_controls">
							<a href="#"><span id="prev-gal"><?php _e('&larr;', 'theme1885'); ?></span></a> 
							<a href="#"><span id="next-gal"><?php _e('&rarr;', 'theme1885'); ?></span></a>
						</div><!--END Prev&Next -->
