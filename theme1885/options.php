...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		$options['sl_caption_opacity'] = array( "name" => "Opacity of caption",
							"desc" => "Universal caption opacity (1 by default).",
...
*/
add_action( 'customize_register', 'theme1885_register' );

if(!function_exists('theme1885_register')) {

	function theme1885_register($wp_customize) {
		/**
		...
		/*	General
		/*-----------------------------------------------------------------------------------*/
		$wp_customize->add_section( 'theme1885_header', array(
			'title' => __( 'General', 'theme1885' ),
			'priority' => 200
		));
		
		/* Background Image*/
		$wp_customize->add_setting( 'theme1885[body_background][image]', array(
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'body_background_image', array(
			...
			'section' => 'theme1885_header',
			'settings'   => 'theme1885[body_background][image]'
		) ) );
		
		
		/* Background Color*/
		$wp_customize->add_setting( 'theme1885[body_background][color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'body_background', array(
			...
			'section' => 'theme1885_header',
			'settings'   => 'theme1885[body_background][color]'
		) ) );
		
		/* Header Color */
		$wp_customize->add_setting( 'theme1885[header_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_color', array(
			...
			'section' => 'theme1885_header',
			'settings'   => 'theme1885[header_color]'
		) ) );
		
		
		/* Body Font Face */
		$wp_customize->add_setting( 'theme1885[google_mixed_3][face]', array(
			'default' => $options['google_mixed_3']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_google_mixed_3', array(
				'label' => $options['google_mixed_3']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[google_mixed_3][face]',
				'type' => 'select',
		...
		$wp_customize->add_setting( 'theme1885[links_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'links_color', array(
			...
			'section' => 'theme1885_header',
			'settings'   => 'theme1885[links_color]'
		) ) );
		
		/* H1 Heading font face */
		$wp_customize->add_setting( 'theme1885[h1_heading][face]', array(
			'default' => $options['h1_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_h1_heading', array(
				'label' => $options['h1_heading']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[h1_heading][face]',
				'type' => 'select',
				'choices' => $options['h1_heading']['options']['faces']
		) );
		
		/* H2 Heading font face */
		$wp_customize->add_setting( 'theme1885[h2_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_h2_heading', array(
				'label' => $options['h2_heading']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[h2_heading][face]',
				'type' => 'select',
				'choices' => $options['h2_heading']['options']['faces']
		) );
		
		/* H6 Heading font face */
		$wp_customize->add_setting( 'theme1885[h6_heading][face]', array(
			'default' => $options['h6_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_h6_heading', array(
				'label' => $options['h6_heading']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[h6_heading][face]',
				'type' => 'select',
				'choices' => $options['h6_heading']['options']['faces']
		) );
		
		/* H5 Heading font face */
		$wp_customize->add_setting( 'theme1885[h5_heading][face]', array(
			'default' => $options['h5_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_h5_heading', array(
				'label' => $options['h5_heading']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[h5_heading][face]',
				'type' => 'select',
				'choices' => $options['h5_heading']['options']['faces']
		) );
		
		/* H4 Heading font face */
		$wp_customize->add_setting( 'theme1885[h4_heading][face]', array(
			'default' => $options['h4_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_h4_heading', array(
				'label' => $options['h4_heading']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[h4_heading][face]',
				'type' => 'select',
				'choices' => $options['h4_heading']['options']['faces']
		) );
		
		/* H3 Heading font face */
		$wp_customize->add_setting( 'theme1885[h3_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1885_h3_heading', array(
				'label' => $options['h3_heading']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[h3_heading][face]',
				'type' => 'select',
		...
		/* Search Box */
		$wp_customize->add_setting( 'theme1885[g_search_box_id]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_g_search_box_id', array(
				'label' => $options['g_search_box_id']['name'],
				'section' => 'theme1885_header',
				'settings' => 'theme1885[g_search_box_id]',
		...
		$wp_customize->add_section( 'theme1885_logo', array(
			'title' => __( 'Logo', 'theme1885' ),
			'priority' => 201
		) );
		
		/* Logo Type */
		$wp_customize->add_setting( 'theme1885[logo_type]', array(
				'default' => $options['logo_type']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_logo_type', array(
				'label' => $options['logo_type']['name'],
				'section' => 'theme1885_logo',
				'settings' => 'theme1885[logo_type]',
				'type' => $options['logo_type']['type'],
				'choices' => $options['logo_type']['options']
		) );
		
		/* Logo Path */
		$wp_customize->add_setting( 'theme1885[logo_url]', array(
			'type' => 'option'
		) );
		...
		$wp_customize->add_section( 'theme1885_slider', array(
			'title' => __( 'Slider', 'theme1885' ),
			'priority' => 202
		) );
		
		/* Slider Effect */
		$wp_customize->add_setting( 'theme1885[sl_effect]', array(
				'default' => $options['sl_effect']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_effect', array(
				'label' => $options['sl_effect']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_effect]',
				'type' => $options['sl_effect']['type'],
				'choices' => $options['sl_effect']['options']
		) );
		
		/* Slices */
		$wp_customize->add_setting( 'theme1885[sl_slices]', array(
				'default' => $options['sl_slices']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_slices', array(
				'label' => $options['sl_slices']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_slices]',
				'type' => $options['sl_slices']['type'],
				'choices' => $options['sl_slices']['options']
		) );
		
		/* Box columns */
		$wp_customize->add_setting( 'theme1885[sl_box_columns]', array(
				'default' => $options['sl_box_columns']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_box_columns', array(
				'label' => $options['sl_box_columns']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_box_columns]',
				'type' => $options['sl_box_columns']['type'],
				'choices' => $options['sl_box_columns']['options']
		) );
		
		/* Box rows */
		$wp_customize->add_setting( 'theme1885[sl_box_rows]', array(
				'default' => $options['sl_box_rows']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_box_rows', array(
				'label' => $options['sl_box_rows']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_box_rows]',
		...
		/* Animation speed */
		$wp_customize->add_setting( 'theme1885[sl_animation_speed]', array(
				'default' => $options['sl_animation_speed']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_animation_speed', array(
				'label' => $options['sl_animation_speed']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_animation_speed]',
				'type' => $options['sl_animation_speed']['type']
		) );
		
		/* Pause time */
		$wp_customize->add_setting( 'theme1885[sl_pausetime]', array(
				'default' => $options['sl_pausetime']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_pausetime', array(
				'label' => $options['sl_pausetime']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_pausetime]',
				'type' => $options['sl_pausetime']['type']
		) );
		
		
		/* Display next & prev navigation? */
		$wp_customize->add_setting( 'theme1885[sl_dir_nav]', array(
				'default' => $options['sl_dir_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_dir_nav', array(
				'label' => $options['sl_dir_nav']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_dir_nav]',
		...
		$wp_customize->add_setting( 'theme1885[sl_dir_nav_hide]', array(
				'default' => $options['sl_dir_nav_hide']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_dir_nav_hide', array(
				'label' => $options['sl_dir_nav_hide']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_dir_nav_hide]',
		...
		/* Show pagination? */
		$wp_customize->add_setting( 'theme1885[sl_control_nav]', array(
				'default' => $options['sl_control_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_sl_control_nav', array(
				'label' => $options['sl_control_nav']['name'],
				'section' => 'theme1885_slider',
				'settings' => 'theme1885[sl_control_nav]',
		...
		$wp_customize->add_section( 'theme1885_blog', array(
				'title' => __( 'Blog', 'theme1885' ),
				'priority' => 203
		) );
		
		/* Blog image size */
		$wp_customize->add_setting( 'theme1885[post_image_size]', array(
				'default' => $options['post_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_post_image_size', array(
				'label' => $options['post_image_size']['name'],
				'section' => 'theme1885_blog',
				'settings' => 'theme1885[post_image_size]',
				'type' => $options['post_image_size']['type'],
				'choices' => $options['post_image_size']['options']
		) );
		
		/* Single post image size */
		$wp_customize->add_setting( 'theme1885[single_image_size]', array(
				'default' => $options['single_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_single_image_size', array(
				'label' => $options['single_image_size']['name'],
				'section' => 'theme1885_blog',
				'settings' => 'theme1885[single_image_size]',
				'type' => $options['single_image_size']['type'],
				'choices' => $options['single_image_size']['options']
		) );
		
		/* Post Meta */
		$wp_customize->add_setting( 'theme1885[post_meta]', array(
				'default' => $options['post_meta']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_post_meta', array(
				'label' => $options['post_meta']['name'],
				'section' => 'theme1885_blog',
				'settings' => 'theme1885[post_meta]',
				'type' => $options['post_meta']['type'],
				'choices' => $options['post_meta']['options']
		) );
		
		/* Post Excerpt */
		$wp_customize->add_setting( 'theme1885[post_excerpt]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_post_excerpt', array(
				'label' => $options['post_excerpt']['name'],
				'section' => 'theme1885_blog',
				'settings' => 'theme1885[post_excerpt]',
		...
		$wp_customize->add_section( 'theme1885_footer', array(
			'title' => __( 'Footer', 'theme1885' ),
			'priority' => 204
		) );
			
		/* Footer Copyright Text */
		$wp_customize->add_setting( 'theme1885[footer_text]', array(
				'default' => $options['footer_text']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_footer_text', array(
				'label' => $options['footer_text']['name'],
				'section' => 'theme1885_footer',
				'settings' => 'theme1885[footer_text]',
				'type' => 'text'
		) );
		
		
		/* Display Footer Menu */
		$wp_customize->add_setting( 'theme1885[footer_menu]', array(
				'default' => $options['footer_menu']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1885_footer_menu', array(
				'label' => $options['footer_menu']['name'],
				'section' => 'theme1885_footer',
				'settings' => 'theme1885[footer_menu]',
